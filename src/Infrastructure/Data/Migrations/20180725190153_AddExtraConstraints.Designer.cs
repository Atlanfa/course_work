...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eshop.ApplicationCore.Entities.BasketAggregate.BasketItem", b =>
                {
                    b.HasOne("eshop.ApplicationCore.Entities.BasketAggregate.Basket")
                        .WithMany("Items")
                    ...
                    b.OwnsOne("eshop.ApplicationCore.Entities.OrderAggregate.Address", "ShipToAddress", b1 =>
                        {
                            ...
                            b1.HasOne("eshop.ApplicationCore.Entities.OrderAggregate.Order")
                                .WithOne("ShipToAddress")
                                .HasForeignKey("eshop.ApplicationCore.Entities.OrderAggregate.Address", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("eshop.ApplicationCore.Entities.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("eshop.ApplicationCore.Entities.OrderAggregate.Order")
                        .WithMany("OrderItems")
                    ...
                    b.OwnsOne("eshop.ApplicationCore.Entities.OrderAggregate.CatalogItemOrdered", "ItemOrdered", b1 =>
                        {
                            ...
                            b1.HasOne("eshop.ApplicationCore.Entities.OrderAggregate.OrderItem")
                                .WithOne("ItemOrdered")
                                .HasForeignKey("eshop.ApplicationCore.Entities.OrderAggregate.CatalogItemOrdered", "OrderItemId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
